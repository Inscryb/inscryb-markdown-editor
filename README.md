[![Build Status](https://travis-ci.org/Inscryb/inscryb-markdown-editor.svg?branch=master)](https://travis-ci.org/Inscryb/inscryb-markdown-editor)
...
- **negativeTabIndex**: Set a negative tab index on the icons in the toolbar. Defaults to `true`.
